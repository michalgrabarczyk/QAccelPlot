...
| Type | Name |
| ---: | :--- |
| virtual void | [**interpolate**](#function-interpolate) (float easedProgress, const std::vector&lt; float &gt; & fromData, int fromPointCount, const std::vector&lt; float &gt; & toData, int toPointCount, std::vector&lt; float &gt; & outData, int & outPointCount) override<br>_Interpolates point positions between the two datasets at_ _easedProgress_ _(0–1)._ |
