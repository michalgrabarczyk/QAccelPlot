...
/// baseline. Both the fill direction and color stops are taken from a Qt \c Gradient object
/// assigned to \c gradient.
///
/// \sa GradientStroke, LineCurveEffect, LineCurve
