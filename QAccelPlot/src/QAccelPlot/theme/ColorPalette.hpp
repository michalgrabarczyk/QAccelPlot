...
/// \brief A named set of theme colors shared by QML (via the \c Colors singleton) and C++ defaults.
///
/// This is the single source of truth for QAccelPlot's color theme. C++ property defaults use
/// \c ColorPalette::dark(); QML accesses both palettes as \c Colors.light and \c Colors.dark.
...
public:
    ...
    /// \brief Returns the light palette.
