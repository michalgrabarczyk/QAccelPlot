...
PALETTE_HEADER = REPO_ROOT / "QAccelPlot" / "src" / "QAccelPlot" / "theme" / "ColorPalette.hpp"
PALETTE_SOURCE = REPO_ROOT / "QAccelPlot" / "src" / "QAccelPlot" / "theme" / "ColorPalette.cpp"
...
def render(palettes: dict[str, dict[str, str]]) -> str:
    lines = [
        ...
        " * QAccelPlot/src/QAccelPlot/theme/ColorPalette.cpp. Do not edit by hand.",
        " */",
    ]
