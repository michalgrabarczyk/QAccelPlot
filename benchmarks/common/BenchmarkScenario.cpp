...
std::vector<BenchmarkScenario> BenchmarkScenario::defaultScenarios()
{
    return {
        ...
        {QStringLiteral("live_multi_5x200k"), QStringLiteral("Multi 5×200K"),
            QStringLiteral("Existing buffers copied into five 200K-point curves every frame (1M points total)"), 200'000, 5, UpdateMode::Live, 10, 2},
        {QStringLiteral("live_multi_5x400k"), QStringLiteral("Multi 5×400K"),
            QStringLiteral("Existing buffers copied into five 400K-point curves every frame (2M points total)"), 400'000, 5, UpdateMode::Live, 10, 2},
        {QStringLiteral("live_multi_5x1m"), QStringLiteral("Multi 5×1M"),
            QStringLiteral("Existing buffers copied into five 1M-point curves every frame (5M points total) — stress test"), 1'000'000, 5, UpdateMode::Live, 10, 2},
        {QStringLiteral("live_multi_5x2m"), QStringLiteral("Multi 5×2M"),
            QStringLiteral("Existing buffers copied into five 2M-point curves every frame (10M points total) — extreme stress test"), 2'000'000, 5, UpdateMode::Live,
            10, 2},
