...
Browse these use-case guides to learn how to build common QAccelPlot plots.
Each guide explains the approach and links to a complete runnable example.

| Use case | Covers |
| --- | --- |
| [Basic static plot](basic-plot.md) | Axes, several curves, markers, and a legend |
| [Real-time scrolling data](realtime.md) | A fixed window updated once per rendered frame |
