...
The built-in ramps are `Viridis`, `Plasma`, `Inferno`, `Magma`, `Grayscale`, and `Rainbow`.
Prefer the perceptually uniform ones over `Rainbow`, whose uneven lightness invents boundaries that
are not in the data.
